...
void main() {
  ...
  test('three recent learner records retain their sources and are found again',
      () async {
    ...
    final userId = (jsonDecode(createUser.body)['user']['id'] as num).toInt();
    ...
    final readBack = await http.get(Uri.parse('$host/api/notes/$userId'));
    expect(readBack.statusCode, 200);
    final notes = (jsonDecode(readBack.body) as List).cast<Map<String, dynamic>>();
